...
class TrainingHelper(TrainingHelperBase):
    def __init__(self, input_size, sequence_length, sos_emb, time_major=False,
        ...
        with ops.name_scope(name, "TrainingHelper", [sequence_length]):
    ...
    def initialize(self, name=None):
        with ops.name_scope(name, "TrainingHelperInitialize"):
            ...
            next_inputs = self._start_inputs
...
class GreedyEmbeddingHelper(GreedyEmbeddingHelperBase):
    def __init__(self, batch_size, input_size, end_token, sos_emb,
            output_layer=None):
